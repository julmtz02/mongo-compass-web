...
const selectFieldsToExport = () => {
    return async (dispatch, getState, { connections, logger: { log, mongoLogId } }) => {
        ...
        try {
            ...
            log.error(mongoLogId(1001000184), 'Export', 'Failed to gather fields for selecting for export', err);
            dispatch({
    ...
    return async (dispatch, getState, { connections, preferences, track, logger: { log, mongoLogId } }) => {
        ...
        const query = exportFullCollection || aggregation
            ...
            : selectedFieldOption === 'select-fields'
                ...
                : _query;
        log.info(mongoLogId(1001000185), 'Export', 'Start export', {
            namespace,
            filePath,
            fileType,
        ...
        try {
            ...
            log.info(mongoLogId(1001000186), 'Export', 'Finished export', {
                namespace,
            ...
            log.error(mongoLogId(1001000187), 'Export', 'Export failed', {
                namespace,
                error: err?.message,
            });
            dispatch({
