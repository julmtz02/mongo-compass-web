...
exports.ExportCodeView = exports.UnconnectedExportCodeView = exports.codeElementId = void 0;
...
function ExportCodeView({ ns, query, aggregation, fields, selectedFieldOption, }) {
    ...
    return (react_1.default.createElement("div", { className: containerStyles },
        react_1.default.createElement(compass_components_1.Body, null,
            ...
            " below"),
        react_1.default.createElement(compass_components_1.Code, { className: codeStyles, "data-testid": "export-collection-code-preview-wrapper", id: exports.codeElementId, language: "javascript", copyable: true }, code)));
}
