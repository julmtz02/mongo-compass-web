...
const compass_app_registry_1 = require("@mongodb-js/compass-app-registry");
 ...
 * The import plugin.
 */
exports.ImportPlugin = (0, compass_app_registry_1.registerCompassPlugin)({
    name: 'Import',
 ...
 * The export plugin.
 */
exports.ExportPlugin = (0, compass_app_registry_1.registerCompassPlugin)({
    name: 'Export',
