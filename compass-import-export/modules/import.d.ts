...
export declare const STARTED = "import-export/import/STARTED";
export declare const CANCELED = "import-export/import/CANCELED";
export declare const FINISHED = "import-export/import/FINISHED";
export declare const FAILED = "import-export/import/FAILED";
export declare const ERROR_DETAILS_OPENED = "import-export/import/ERROR_DETAILS_OPENED";
export declare const ERROR_DETAILS_CLOSED = "import-export/import/ERROR_DETAILS_CLOSED";
export declare const FILE_TYPE_SELECTED = "import-export/import/FILE_TYPE_SELECTED";
export declare const FILE_SELECTED = "import-export/import/FILE_SELECTED";
export declare const FILE_SELECT_ERROR = "import-export/import/FILE_SELECT_ERROR";
export declare const OPEN = "import-export/import/OPEN";
export declare const CLOSE = "import-export/import/CLOSE";
export declare const OPEN_IN_PROGRESS_MESSAGE = "import-export/import/OPEN_IN_PROGRESS_MESSAGE";
export declare const CLOSE_IN_PROGRESS_MESSAGE = "import-export/import/CLOSE_IN_PROGRESS_MESSAGE";
export declare const SET_PREVIEW = "import-export/import/SET_PREVIEW";
export declare const SET_DELIMITER = "import-export/import/SET_DELIMITER";
export declare const SET_GUESSTIMATED_TOTAL = "import-export/import/SET_GUESSTIMATED_TOTAL";
export declare const SET_STOP_ON_ERRORS = "import-export/import/SET_STOP_ON_ERRORS";
export declare const SET_IGNORE_BLANKS = "import-export/import/SET_IGNORE_BLANKS";
export declare const TOGGLE_INCLUDE_FIELD = "import-export/import/TOGGLE_INCLUDE_FIELD";
export declare const SET_FIELD_TYPE = "import-export/import/SET_FIELD_TYPE";
export declare const ANALYZE_STARTED = "import-export/import/ANALYZE_STARTED";
export declare const ANALYZE_FINISHED = "import-export/import/ANALYZE_FINISHED";
export declare const ANALYZE_FAILED = "import-export/import/ANALYZE_FAILED";
export declare const ANALYZE_CANCELLED = "import-export/import/ANALYZE_CANCELLED";
export declare const ANALYZE_PROGRESS = "import-export/import/ANALYZE_PROGRESS";
